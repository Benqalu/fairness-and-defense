...
#np.random.seed(1000)
print('test sample size :',f_evaluate.shape[0])
...
np.savez(result_folder+"/attack/"+"noise_data_{}.npz".format(args.qt),x=x_evaluate,defense_output=result_array,defense_output_logits=result_array_logits,tc_output=f_evaluate_origin,tc_output_logits=f_evaluate_logits_origin,predict_origin=predict_origin,predict_modified=predict_modified)
