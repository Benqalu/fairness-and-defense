...
class InputData():
    ...
    def input_data_user(self):
        ...
        x_train_user=x_data[int(self.user_training_data_range["start"]):int(self.user_training_data_range["end"])]
        x_test_user=x_data[int(self.user_testing_data_range["start"]):int(self.user_testing_data_range["end"])]
        y_train_user=y_data[int(self.user_training_data_range["start"]):int(self.user_training_data_range["end"])]
        y_test_user=y_data[int(self.user_testing_data_range["start"]):int(self.user_testing_data_range["end"])]
    ...
    def input_data_defender(self):
        ...
        npzdata_index=np.load(self.index_filepath)
        index_data=npzdata_index['x']
        x_train_user=x_data[int(self.defense_member_data_index_range["start"]):int(self.defense_member_data_index_range["end"])]
        x_nontrain_defender=x_data[int(self.defense_nonmember_data_index_range["start"]):int(self.defense_nonmember_data_index_range["end"])]
        y_train_user=y_data[int(self.defense_member_data_index_range["start"]):int(self.defense_member_data_index_range["end"])]
        y_nontrain_defender=y_data[int(self.defense_nonmember_data_index_range["start"]):int(self.defense_nonmember_data_index_range["end"])]
    ...
    def input_data_attacker_adv1(self):
        ...
        x_train_member_attacker=x_data[int(self.attacker_train_member_data_range["start"]):int(self.attacker_train_member_data_range["end"])]
        x_train_nonmember_attacker=x_data[int(self.attacker_train_nonmember_data_range["start"]):int(self.attacker_train_nonmember_data_range["end"])]
        y_train_member_attacker=y_data[int(self.attacker_train_member_data_range["start"]):int(self.attacker_train_member_data_range["end"])]
        y_train_nonmumber_attacker=y_data[int(self.attacker_train_nonmember_data_range["start"]):int(self.attacker_train_nonmember_data_range["end"])]
    ...
    def input_data_attacker_evaluate(self):
        ...
        x_evaluate_member_attacker=x_data[int(self.attacker_evaluate_member_data_range["start"]):int(self.attacker_evaluate_member_data_range["end"])]
        x_evaluate_nonmember_attacker=x_data[int(self.attacker_evaluate_nonmember_data_range["start"]):int(self.attacker_evaluate_nonmember_data_range["end"])]
        y_evaluate_member_attacker=y_data[int(self.attacker_evaluate_member_data_range["start"]):int(self.attacker_evaluate_member_data_range["end"])]
        y_evaluate_nonmumber_attacker=y_data[int(self.attacker_evaluate_nonmember_data_range["start"]):int(self.attacker_evaluate_nonmember_data_range["end"])]
